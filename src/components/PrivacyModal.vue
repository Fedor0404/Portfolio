    ...
    <transition name="modal-fade">
        <div class="overlay">
            <div class="modal-window">
                <button class="modal-window__close" @click="close">x</button>
                <header class="modal-window__subtitle">
                    <slot name="header">
                        Политика в отношении обработки персональных данных
                    </slot>
                </header>
                <section class="modal-window__descr">
                    <slot name="body">
                        <div class="privacy">
                            <div class="container">
                                ...
                                <p>
                                    ...
                                    Кормачевым Федором Владимировичем (далее –
                                    Оператор).
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    веб-сайта https://clean-control.ru.
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    прав субъектов персональных данных по
                                    запросу этого органа необходимую информацию
                                    в течение 30 дней с даты получения такого
                                    запроса;
                                    <br />
                                ...
                                <p>
                                    ...
                                    его персональных данных, за исключением
                                    случаев, предусмотренных федеральными
                                    законами. Сведения предоставляются субъекту
                                    ...
                                    согласия при обработке персональных данных в
                                    целях продвижения на рынке товаров, работ и
                                    услуг;
                                    <br />
                                    ...
                                    или в судебном порядке неправомерные
                                ...
                                <p>
                                    ...
                                    (обновлении, изменении) своих персональных
                                    данных.
                                </p>
                                <p>
                                ...
                                <p>
                                    5.4. Идентификационный номер
                                    налогоплательщика, дата постановки его на
                                    учет, реквизиты свидетельства постановки на
                                    учет в налоговом органе.
                                </p>
                                <p>
                                    5.5. Также на сайте происходит сбор и
                                ...
                                <p>
                                    5.6. Вышеперечисленные данные далее по
                                    тексту Политики объединены общим понятием
                                    Персональные данные.
                                </p>
                                <p>
                                    5.7. Обработка специальных категорий
                                ...
                                <p>
                                    5.9. Согласие Пользователя на обработку
                                ...
                                <p>
                                    5.9.2 Оператор обязан в срок не позднее трех
                                ...
                                <p>
                                    5.9.3 Передача (распространение,
                                    предоставление, доступ) персональных данных,
                                ...
                                <p>
                                    5.9.4 Согласие на обработку персональных
                                    данных, разрешенных для распространения,
                                    прекращает свое действие с момента
                                    поступления Оператору требования, указанного
                                    в п. 5.9.3 настоящей Политики в отношении
                                ...
                                <p>
                                    ...
                                    support@clean-control.ru с пометкой «Отказ
                                    от уведомлений о новых продуктах и услугах и
                                ...
                                <p>
                                    ...
                                    https://clean-control.ru или направленные
                                    Оператору посредством электронной почты.
                                    Заполняя соответствующие формы и/или
                                ...
                                <p>
                                    ...
                                    support@clean-control.ru с пометкой
                                ...
                                <p>
                                    ...
                                    адрес Оператора support@clean-control.ru с
                                ...
                                <p>
                                    ...
                                    самостоятельно своевременно ознакомиться с
                                ...
                                <p>
                                    ...
                                    электронной почты support@clean-control.ru.
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    адресу https://clean-control.ru/privacy.
                                </p>
                            </div>
                        </div></slot
                    >
