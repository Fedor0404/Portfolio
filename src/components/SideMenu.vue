<template>
    <div>
        <div class="menu" v-bind:class="classObject">
            <HamburgerPromo @onClick="openMenu" />
    ...
    methods: {
        openMenu() {
            if (!this.classObject.active) {
                // this.classObject.deactivation = false;
                this.classObject.active = true;
                this.classObject.deactivation = false;
            }
        },
        closeMenu() {
            if (!this.classObject.deactivation) {
                this.classObject.active = false;
                this.classObject.deactivation = true;
            }
        },
    },
};
